...
return [
    ...
    [ // $staticRoutes
        ...
        '/debug/kpi' => [[['_route' => 'debug_kpi', '_controller' => 'App\\Controller\\DebugController::debugKpi'], null, null, null, false, false, null]],
        ...
        '/nomenclature/new' => [[['_route' => 'nomenclature_new', '_controller' => 'App\\Controller\\NomenclatureController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        ...
        '/api/stats/ca-12-mois' => [[['_route' => 'api_stats_ca_12_mois', '_controller' => 'App\\Controller\\RegistrationController::ca12Mois'], null, null, null, false, false, null]],
        '/stats' => [[['_route' => 'stats_general', '_controller' => 'App\\Controller\\StatisticsController::general'], null, null, null, false, false, null]],
        '/stats/ventes' => [[['_route' => 'stats_ventes', '_controller' => 'App\\Controller\\StatisticsController::ventes'], null, null, null, false, false, null]],
        '/stats/achats' => [[['_route' => 'stats_achats', '_controller' => 'App\\Controller\\StatisticsController::achats'], null, null, null, false, false, null]],
        '/stats/productions' => [[['_route' => 'stats_productions', '_controller' => 'App\\Controller\\StatisticsController::productions'], null, null, null, false, false, null]],
        '/stats/api/kpi/ca-mois' => [[['_route' => 'api_kpi_ca_mois', '_controller' => 'App\\Controller\\StatisticsController::apiKpiCaMois'], null, null, null, false, false, null]],
        '/stats/api/kpi/dep-mois' => [[['_route' => 'api_kpi_dep_mois', '_controller' => 'App\\Controller\\StatisticsController::apiKpiDepMois'], null, null, null, false, false, null]],
        '/stats/api/kpi/ruptures-count' => [[['_route' => 'api_kpi_ruptures_count', '_controller' => 'App\\Controller\\StatisticsController::apiKpiRupturesCount'], null, null, null, false, false, null]],
        '/stats/api/ventes/ca-par-jour' => [[['_route' => 'api_stats_ventes_ca_jour', '_controller' => 'App\\Controller\\StatisticsController::apiVentesCaJour'], null, null, null, false, false, null]],
        '/stats/api/achats/depenses-par-jour' => [[['_route' => 'api_stats_achats_dep_jour', '_controller' => 'App\\Controller\\StatisticsController::apiAchatsDepJour'], null, null, null, false, false, null]],
        '/stats/api/stock/valeur-par-depot' => [[['_route' => 'api_stats_stock_val_depot', '_controller' => 'App\\Controller\\StatisticsController::apiStockParDepot'], null, null, null, false, false, null]],
        '/stats/api/docs/repartition-type' => [[['_route' => 'api_stats_docs_repartition', '_controller' => 'App\\Controller\\StatisticsController::apiDocsRepartition'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        330 => [[['_route' => 'app_documents_edit', '_controller' => 'App\\Controller\\DocumentsController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        338 => [
            [['_route' => 'app_documents_delete', '_controller' => 'App\\Controller\\DocumentsController::delete'], ['id'], ['POST' => 0], null, false, true, null],
            [['_route' => 'app_documents_show', '_controller' => 'App\\Controller\\DocumentsController::show'], ['id'], ['GET' => 0], null, false, true, null],
        ],
