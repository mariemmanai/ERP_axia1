 ...
 */
class getFunctionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FunctionRepository' shared autowired service.
     *
     * @return \App\Repository\FunctionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FunctionRepository.php';

        return $container->privates['App\\Repository\\FunctionRepository'] = new \App\Repository\FunctionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
