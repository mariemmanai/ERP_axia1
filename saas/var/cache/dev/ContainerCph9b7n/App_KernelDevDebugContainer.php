...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DepotsController' => 'getDepotsControllerService',
            'App\\Controller\\DocumentsController' => 'getDocumentsControllerService',
            'App\\Controller\\FunctionsController' => 'getFunctionsControllerService',
            'App\\Controller\\HomeController' => 'getHomeControllerService',
            'App\\Controller\\NomenclatureController' => 'getNomenclatureControllerService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $d->registerBus('messenger.bus.default', ($container->services['messenger.default_bus'] ?? self::getMessenger_DefaultBusService($container)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dmE-kSA3W5', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uxYmJxjOLm', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('exfvH3eeJ8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Xb4J6f679W', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\DepotsRepository' => ['privates', 'App\\Repository\\DepotsRepository', 'getDepotsRepositoryService', true],
            'App\\Repository\\DocumentsRepository' => ['privates', 'App\\Repository\\DocumentsRepository', 'getDocumentsRepositoryService', true],
            'App\\Repository\\DocumentsligneRepository' => ['privates', 'App\\Repository\\DocumentsligneRepository', 'getDocumentsligneRepositoryService', true],
            'App\\Repository\\FunctionRepository' => ['privates', 'App\\Repository\\FunctionRepository', 'getFunctionRepositoryService', true],
            'App\\Repository\\FunctionsRepository' => ['privates', 'App\\Repository\\FunctionsRepository', 'getFunctionsRepositoryService', true],
            'App\\Repository\\NomenclatureRepository' => ['privates', 'App\\Repository\\NomenclatureRepository', 'getNomenclatureRepositoryService', true],
            'App\\Repository\\ProfileFunctionsRepository' => ['privates', 'App\\Repository\\ProfileFunctionsRepository', 'getProfileFunctionsRepositoryService', true],
            ...
            'App\\Repository\\DocumentsligneRepository' => '?',
            'App\\Repository\\FunctionRepository' => '?',
            'App\\Repository\\FunctionsRepository' => '?',
            'App\\Repository\\NomenclatureRepository' => '?',
            'App\\Repository\\ProfileFunctionsRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ArticlesController', 'App\\Controller\\DepotsController', 'App\\Controller\\DocumentsController', 'App\\Controller\\FunctionsController', 'App\\Controller\\HomeController', 'App\\Controller\\NomenclatureController', 'App\\Controller\\ProfilesController', 'App\\Controller\\RegistrationController', 'App\\Controller\\StockController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mICZkmF8lX', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z8yDcng8xL', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gSx-ABBnw4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8ArzDYiRmu', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('u6117BwAf6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        (new \Symfony\Bundle\TwigBundle\DependencyInjection\Configurator\EnvironmentConfigurator('d/m/Y', '%d jours', NULL, 2, ',', ' '))->configure($instance);
