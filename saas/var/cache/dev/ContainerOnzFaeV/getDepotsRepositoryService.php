 ...
 */
class getDepotsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DepotsRepository' shared autowired service.
     *
     * @return \App\Repository\DepotsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DepotsRepository.php';

        return $container->privates['App\\Repository\\DepotsRepository'] = new \App\Repository\DepotsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
