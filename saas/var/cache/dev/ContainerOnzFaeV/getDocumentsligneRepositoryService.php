 ...
 */
class getDocumentsligneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocumentsligneRepository' shared autowired service.
     *
     * @return \App\Repository\DocumentsligneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocumentsligneRepository.php';

        return $container->privates['App\\Repository\\DocumentsligneRepository'] = new \App\Repository\DocumentsligneRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
