 ...
 */
class getProfileFunctionsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfileFunctionsRepository' shared autowired service.
     *
     * @return \App\Repository\ProfileFunctionsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfileFunctionsRepository.php';

        return $container->privates['App\\Repository\\ProfileFunctionsRepository'] = new \App\Repository\ProfileFunctionsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
