 ...
 */
class getNomenclatureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NomenclatureRepository' shared autowired service.
     *
     * @return \App\Repository\NomenclatureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NomenclatureRepository.php';

        return $container->privates['App\\Repository\\NomenclatureRepository'] = new \App\Repository\NomenclatureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
