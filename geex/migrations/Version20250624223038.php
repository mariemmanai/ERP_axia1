 ...
 */
final class Version20250624223038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_D9970FC488B266E3 ON documentslignes (id_document)
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_D9970FC4DCA7A716 ON documentslignes (id_article)
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE documentslignes DROP FOREIGN KEY FK_D9970FC488B266E3
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE documentslignes DROP FOREIGN KEY FK_D9970FC4DCA7A716
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_D9970FC488B266E3 ON documentslignes
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_D9970FC4DCA7A716 ON documentslignes
        SQL);
        $this->addSql(<<<'SQL'
