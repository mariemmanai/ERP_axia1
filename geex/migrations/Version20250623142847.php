 ...
 */
final class Version20250623142847 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE functions CHANGE intitule intitule INT NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE functions CHANGE intitule intitule VARCHAR(255) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE nomenclature DROP FOREIGN KEY FK_41922EE6F347EFB
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE nomenclature DROP FOREIGN KEY FK_41922EE6F46CD258
        SQL);
        $this->addSql(<<<'SQL'
