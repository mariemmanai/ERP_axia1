 ...
 */
class getPermissionVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.voter.App\Security\PermissionVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'PermissionVoter.php';

        $a = ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService());

        if (isset($container->privates['debug.security.voter.App\\Security\\PermissionVoter'])) {
            return $container->privates['debug.security.voter.App\\Security\\PermissionVoter'];
        }

        return $container->privates['debug.security.voter.App\\Security\\PermissionVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\PermissionVoter(($container->privates['App\\Repository\\ProfileFunctionsRepository'] ?? $container->load('getProfileFunctionsRepositoryService'))), $a);
    }
}
