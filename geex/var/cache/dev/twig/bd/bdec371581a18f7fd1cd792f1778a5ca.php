...
class __TwigTemplate_88f80f32275c89aeffed27811a7025df extends Template
{
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["depot"]) || array_key_exists("depot", $context) ? $context["depot"] : (function () { throw new RuntimeError('Variable "depot" does not exist.', 3, $this->source); })()), "id", [], "any", false, false, false, 3)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield "Modifier";
        } else {
            yield "Nouveau";
        }
    ...
    <div class=\"row justify-content-center\">
        <main class=\"col-md-10 col-lg-8 px-md-4\">
            <div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom\">
                <h1 class=\"h2 mb-0\">";
        // line 10
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["depot"]) || array_key_exists("depot", $context) ? $context["depot"] : (function () { throw new RuntimeError('Variable "depot" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
