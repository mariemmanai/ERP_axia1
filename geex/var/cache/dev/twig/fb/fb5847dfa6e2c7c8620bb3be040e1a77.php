...
class __TwigTemplate_153ffc3edd7835a8326a131cf0c6d287 extends Template
{
...
";
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "htmlBody", [], "any", true, true, false, 142)) {
                        ...
                        // line 145
                        yield "                                                ";
                        if ((($tmp =  !(null === (isset($context["htmlBody"]) || array_key_exists("htmlBody", $context) ? $context["htmlBody"] : (function () { throw new RuntimeError('Variable "htmlBody" does not exist.', 145, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 146
                            yield "                                                    <div class=\"tab\">
                            ...
                            yield "\"
                                                    ...
                                                    <div class=\"tab\">
                                                        ...
                                                        <div class=\"tab-content\">
                                                            <pre class=\"prewrap\" style=\"max-height: 600px\">";
                            // line 162
                            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 162, $this->source); })()), "htmlCharset", [], "method", false, false, false, 162)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                                // line 163
                        ...
                        // line 172
                        yield "                                                ";
                        if ((($tmp =  !(null === (isset($context["textBody"]) || array_key_exists("textBody", $context) ? $context["textBody"] : (function () { throw new RuntimeError('Variable "textBody" does not exist.', 172, $this->source); })()))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                            // line 173
                            yield "                                                    <div class=\"tab\">
                                                        ...
                                                        <div class=\"tab-content\">
                                                            <pre class=\"prewrap\" style=\"max-height: 600px\">";
                            // line 177
                            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 177, $this->source); })()), "textCharset", [], "method", false, false, false, 177)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                                // line 178
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\Users\\Lenovo\\Downloads\\ERP_axia\\ProjetWeb - Copie (2)\\geex\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
