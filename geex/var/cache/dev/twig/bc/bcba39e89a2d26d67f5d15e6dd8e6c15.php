...
class __TwigTemplate_ac06657e9e11eecf5156eb9859098f92 extends Template
{
    ...
    <div class=\"row justify-content-center\"> <!-- Centrage ajouté ici -->
        <main class=\"col-md-10 col-lg-8 px-md-4\"> <!-- Largeur réduite et centrée -->
            <div class=\"d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom\">
                <h1 class=\"h2 mb-0\">Créer un nouvel article</h1>
...
{% endblock %}", "articles/new.html.twig", "C:\\Users\\Lenovo\\Downloads\\ERP_axia\\ProjetWeb - Copie (2)\\geex\\templates\\articles\\new.html.twig");
    }
}
